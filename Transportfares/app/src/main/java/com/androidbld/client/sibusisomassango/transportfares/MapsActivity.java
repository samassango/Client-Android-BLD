...
import com.androidbld.client.sibusisomassango.transportfares.gpslocation.GetNearbyPlacesData;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private GpsLocationTracker gpsLocationTracker,gps;
    double latitude,longitude;
    Button btnRestaurant,btnSchool,btnHospital;
...
//Check whether Google play service available
    ...
    //build Google api client and then enable the user current location.
...
//           // Log.d("lat/lon", latitude+" "+longitude);
...
//        LatLng pointlocation = new LatLng(latitude, longitude);
//        mMap.addMarker(new MarkerOptions().position(pointlocation).title("You"));
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(pointlocation,15));
        ...
        Button btnRestaurant = (Button) findViewById(R.id.btnRestaurant2);
        ...
        Button btnHospital = (Button) findViewById(R.id.btnHospital2);
        ...
        Button btnSchool = (Button) findViewById(R.id.btnSchool2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.btnRestaurant:
                Toast.makeText(getApplicationContext(),"Restaurant Selected",Toast.LENGTH_LONG).show();
                return true;
